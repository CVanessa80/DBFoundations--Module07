...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assigment07DB_CVanessa')
	 Begin 
	  Alter Database [Assigment07DB_CVanessa] set Single_user With Rollback Immediate;
	  Drop Database Assigment07DB_CVanessa;
	 End
	Create Database Assigment07DB_CVanessa;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assigment07DB_CVanessa;
...
Select
P.ProductName
,[InventoryDate] = DateName (MM, InventoryDate)+ ', ' + DateName (YY, I.InventoryDate)
,[I.InventoryCount] = I.[Count]
From vProducts AS P
Inner Join vInventories AS I
On P.ProductID = I.ProductID
Order BY ProductName, InventoryDate, I.Count;
go
...
, InventoryDate
,InventoryCount
,[PreviusMonthCount] = IIF(InventoryDate Like ('January%'), 0, IsNull(Lag(InventoryCount) Over (Order By ProductName, Year (InventoryDate)), 0) )
...
-- <Put Your Code Here> --
Create --Drop
View fProductInventoriesWithPreviousMonthCountsWithKPIs (@KPI Value int)
Returns Table
As 
Return Select
ProductName
